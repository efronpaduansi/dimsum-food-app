       ...
       //verifikasi password lama
        ...
        if(password_verify($oldPass, $getData['password'])){
            ...
            if($newPass === $passConf){
                ...
                if($update){
                    header("location:http://localhost/dimsum-pawonkulo/view/admin/setting.php?pesan=passChangeSuccess");
                }else{
                    header("location:http://localhost/dimsum-pawonkulo/view/admin/setting.php?pesan=passChangeFailed");
                }
            }else{
                header("location:http://localhost/dimsum-pawonkulo/view/admin/setting.php?pesan=passNotMatch");
            }
